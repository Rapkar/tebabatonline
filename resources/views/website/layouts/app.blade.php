                    ...
                    <div class="col-lg-3 menu">
                        <div class="   d-flex align-items-center shoppingcard">
                            <ul class="col-lg-12 d-flex">
                                <li class="col-lg-2 d-flex align-items-center "><a href="">ورود </a></li>
                                ...
                                <li class="col-lg-3 d-flex align-items-center "><a href="">
    ...
    <svg width="100%" height="100%" id="svg" viewBox="0 0 1440 390" xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150">
        ...
        <defs>
            <linearGradient id="gradient" x1="0%" y1="50%" x2="100%" y2="50%">
                <stop offset="5%" stop-color="#4dcbd3"></stop>
                <stop offset="95%" stop-color="#007c7e"></stop>
            </linearGradient>
        </defs>
        <path d="M 0,400 L 0,150 C 109.96172248803828,164.44019138755982 219.92344497607655,178.8803827751196 298,196 C 376.07655502392345,213.1196172248804 422.26794258373207,232.91866028708134 527,201 C 631.7320574162679,169.08133971291866 795.0047846889953,85.44497607655502 895,76 C 994.9952153110047,66.55502392344498 1031.7129186602872,131.30143540669857 1112,156 C 1192.2870813397128,180.69856459330143 1316.1435406698565,165.3492822966507 1440,150 L 1440,400 L 0,400 Z" stroke="none" stroke-width="0" fill="url(#gradient)" fill-opacity="1" class="transition-all duration-300 ease-in-out delay-150 path-0"></path>
    </svg>
    <footer>
        <div class="container-fluid">
