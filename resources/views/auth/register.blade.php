            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="phone number" class="col-md-4 col-form-label text-md-end">{{ __('auth.Phone') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="address number" class="col-md-4 col-form-label text-md-end">{{ __('auth.Address') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('auth.Confirm') }}</label>
